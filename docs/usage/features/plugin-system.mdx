...
description: >-
  Explore the diverse plugin ecosystem of SlyyydeChat, extending its capabilities
...
- : This is the plugin index for LobeChat. It retrieves the list of plugins from the index.json of this repository and displays them to the users.
- : Chat Plugin plugin development template, you can quickly create a new plugin project through the project template.
- : The LobeChat plugin SDK can help you create excellent Lobe Chat plugins.
- : The LobeChat plugin gateway is a backend service that serves as the gateway for LobeChat plugins. We deploy this service using Vercel.
